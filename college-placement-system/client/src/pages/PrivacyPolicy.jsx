      ...
      <div className="min-h-screen bg-gray-100 p-8">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-4">
            This Privacy Policy governs the manner in which our website
            collects, uses, maintains, and discloses information collected from
            users (each, a "User") of the website ("Site"). This privacy policy
            applies to the Site and all products and services offered by our
            company.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            ...
            site, register on the site, fill out a form, respond to a survey,
            ...
            appropriate, their name, email address, mailing address, and phone
          ...
          <p className="text-gray-700 mb-4">
            ...
            and the Site or administer activities on our behalves, such as
          ...
          <p className="text-gray-700 mb-4">
            ...
            on our behalves, such as sending out newsletters or surveys. We may
          ...
          <p className="text-gray-700 mb-4">
            Users may find advertising or other content on our Site that links
            ...
            and interaction on any other website, including websites that have a
