    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 mb-4">
          This Privacy Policy governs the manner in which our website collects,
          uses, maintains, and discloses information collected from users (each,
          a "User") of the website ("Site"). This privacy policy applies to the
          Site and all products and services offered by our company.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          site, register on the site, fill out a form, respond to a survey, and
          ...
          their name, email address, mailing address, and phone number. Users
        ...
        <h2 className="text-2xl font-bold mb-4">Web Browser Cookies</h2>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          Our company may collect and use Users' personal information for the
          following purposes:
        </p>
        <ul className="list-disc list-inside text-gray-700 mb-4">
          <li className="mb-2">To run and operate our Site</li>
        ...
        <p className="text-gray-700 mb-4">
          ...
          use third-party service providers to help us operate our business and
          the Site or administer activities on our behalves, such as sending out
        ...
        <h2 className="text-2xl font-bold mb-4">Electronic Newsletters</h2>
        <p className="text-gray-700 mb-4">
          ...
          our behalves, such as sending out newsletters or surveys. We may share
